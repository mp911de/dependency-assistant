= Maven Updater Plugin
Mark Paluch
:experimental:
:github: https://github.com/mp911de/maven-updater
...
image::src/main/resources/META-INF/screenshot.png[Maven Updater dependency check dialog,width=800]

== Installation

Install the plugin named *Maven Updater* from the IDE *Settings / Plugins* marketplace, or build the distribution locally (see <<Building>>) and install the ZIP from disk.
...
Maven Updater is Open Source software released under the https://www.apache.org/licenses/LICENSE-2.0.html[Apache 2.0 license].
