...
An https://plugins.jetbrains.com[IntelliJ IDEA] plugin that helps you upgrade dependencies declared in Maven, Gradle, GitHub Actions, NPM, and Antora projects, plus Maven and Gradle wrapper properties.
...
* Links to release notes and issue trackes when project metadata (e.g. POM, NPM Registry) is available.
