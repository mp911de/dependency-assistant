...
/**
 * Highlights upgrade suggestions and known vulnerabilities from cached
 * metadata.
 * <p>Quick fixes are offered only for version literals in the annotated file.
 * References to versions defined elsewhere remain informational.
 *
 * @author Mark Paluch
 */
