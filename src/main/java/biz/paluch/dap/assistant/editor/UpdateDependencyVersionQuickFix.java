...
import biz.paluch.dap.assistant.action.UpgradeDependenciesIntention;
...
/**
 * A selected update anchored at a dependency version literal.
 * <p>Inspection invocation updates the literal. Intention invocation updates
 * all matching declarations in the file.
 *
 * @author Mark Paluch
 */
class UpdateDependencyVersionQuickFix extends LocalQuickFixOnPsiElement
	...
	protected UpdateDependencyVersionQuickFix(UpgradeStrategy strategy,
		...
		this(context.getDeclaration().getRequiredVersionLiteral(), strategy, context, update);
	}
