...
/**
 * Creates detached dependency presentations from cached metadata and settings.
 * <p>A rule-provided name takes precedence over a remembered name hint. Project
 * names remain separate from the canonical display name.
 *
 * @author Mark Paluch
 */
public class DependencyPresentationFactory {
	...
	/**
	 * Create a presentation with the integration-selected table icon.
	 */
