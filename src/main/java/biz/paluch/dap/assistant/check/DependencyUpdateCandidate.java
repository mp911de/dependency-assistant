 ...
 * @author Mark Paluch
 */
public class DependencyUpdateCandidate implements HasArtifactId {
	 ...
	 */
	public DependencyUpdateCandidate(Dependency dependency, Releases releases,
	 ...
	 */
	public DependencyUpdateCandidate(Dependency dependency, Releases releases, VulnerabilityRepository vulnerabilities,
			DependencyRule rule) {
	 ...
	 */
	public DependencyUpdateCandidate(DependencyUpgradeSubject subject, UpgradeSuggestions suggestions) {
