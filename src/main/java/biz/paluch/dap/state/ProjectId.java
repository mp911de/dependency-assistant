...
/**
 * Identity of an independently tracked dependency context. Namespace and name
 * are logical identifiers and need not be Maven coordinates.
 *
 * @param buildFile optional descriptor path when namespace and name alone do
 * not distinguish contexts within an IDE project.
 * @author Mark Paluch
 */
