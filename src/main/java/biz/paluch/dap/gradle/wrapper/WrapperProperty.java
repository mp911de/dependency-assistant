...
/**
 * Gradle Wrapper property paired with its checksum key.
 * <p>Default URLs use Gradle Services and the {@code bin} flavor. Release
 * selection uses the newest cached non-preview release, falling back to the
 * built-in version.
 *
 * @author Mark Paluch
 */
