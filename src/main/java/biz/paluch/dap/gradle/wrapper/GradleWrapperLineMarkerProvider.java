...
/**
 * Gutter configurable for Gradle wrapper properties.
 *
 * @author Mark Paluch
 */
public class GradleWrapperLineMarkerProvider extends UpgradeAvailableLineMarkerProvider {
	...
	public String getName() {
		return MessageBundle.message("gutter.upgrade-available.name",
				GradleWrapperInterface.INSTANCE.getDisplayName());
	}
	...
	protected ProjectDependencyContext getContext(PsiElement element) {
		...
		if (context instanceof GradleWrapperAssistant.GradleWrapperDependencyContext) {
			return context;
		}
