...
public class GroovyCompletionContributor extends CompletionContributor {
	...
	public GroovyCompletionContributor() {
		...
		PatternCondition<PsiFile> isGradleGrooveDslFile = new PatternCondition<>("isGradleGroovyDslFile") {
		...
		extend(CompletionType.BASIC, PlatformPatterns.psiElement()
				.inside(PlatformPatterns.psiFile().with(isGradleGrooveDslFile)), provider);
	}
