...
public interface ArtifactVersion extends Comparable<ArtifactVersion>, HasVersion {
	...
	/**
	 * Whether this version shares the same {@code major.minor} (semantic) or release train name (release-train) as the
	 * given version.
	 *
	 * @param other the version to compare with, must not be {@code null}.
	 * @return {@code true} if both are in the same {@code major.minor} or train.
	 */
