...
/**
 * Test support for {@link DependencyVersionDriftInspection} integration tests
 * across Maven and Gradle build files.
 *
 * @author Mark Paluch
 */
public class DriftInspections {

	/**
	 * Run the drift inspection over the given file and collect its problems.
	 */
